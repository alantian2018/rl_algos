...
def main(config: PendulumSACConfig):
    ...
    policy_encoder = MLPEncoder(state_dim=config.state_dim, hidden_dim=config.hidden_dim)
    ...
    qf1 = Qfunction(encoder=qf1_encoder, action_dim=config.action_dim, hidden_dim=config.hidden_dim)
    qf2 = Qfunction(encoder=qf2_encoder, action_dim=config.action_dim, hidden_dim=config.hidden_dim)
